...
import depromeet.hotsix.obrit.notification.controller.docs.FcmTokenControllerApi
...
class FcmTokenController(private val fcmTokenService: FcmTokenService) : FcmTokenControllerApi {
    @PostMapping
